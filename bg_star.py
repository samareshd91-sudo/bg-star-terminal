...
def trigger_pro_alerts(coin, direction, entry, delay_index=0):
    ...
    audio_id = f"alarm_{safe_coin}_{direction}"
    ls_key = f"lastSMCAlert_{safe_coin}_{direction}"
...
# ==========================================
# 6. Parallel Scanning & Dashboard UI
# ==========================================
...
# ==========================================
# 7. Signal Execution & UI Rendering
# ==========================================
if detected_signals:
